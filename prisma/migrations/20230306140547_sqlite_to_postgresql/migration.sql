...
CREATE TABLE "RecipeToIngredient" (
    ...
    CONSTRAINT "RecipeToIngredient_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "RecipeToIngredient" ADD CONSTRAINT "RecipeToIngredient_recipeId_fkey" FOREIGN KEY ("recipeId") REFERENCES "Recipe"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RecipeToIngredient" ADD CONSTRAINT "RecipeToIngredient_ingredientId_fkey" FOREIGN KEY ("ingredientId") REFERENCES "Ingredient"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
